...
<head>
    ...
    <link href="WZakaz.css" type="text/css" rel="stylesheet">
    <title>Профиль</title>
</head>
...
<body>
    ...
    <div class = menu-select>
        ...
        <form method = "POST" action = "../PostZakaz/Zakaz.php">
            <button id = 'menuButtOrder' class = 'OrderButt'>Поступившие заказы</button> 
        </form>

        <form>
            <button class = 'lkButt1' disabled>Ожидающие заказы</button> 
        </form>
